...
//    rightTarget->setPos(ScreenResolutionWidth*(1-SIDE_MARGIN)-diameter,centerY-target_radious);
    ...
    qreal diameter = (resolutionWidth*TARGET_TOL);
    qreal targetDiamteter = (resolutionWidth*TARGET_SIZE);
    ...
    QRectF leftTarget(resolutionWidth*SIDE_MARGIN - xOffset,cY-r,diameter,diameter);
    QRectF rightTarget(resolutionWidth*(1-SIDE_MARGIN) - diameter + xOffset,cY-r,diameter,diameter);
    targetBoxes.clear();
    ...
    qreal line_length = resolutionWidth*CROSS_LINE_LENGTH;
