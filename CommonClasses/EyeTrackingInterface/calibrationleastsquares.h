...
public:
    ...
    RenderServerScene getCurrentCalibrationImage() const;
...
private:
    ...
    // Convenience function for all the steps when reaching the last validation point.
    void finalizeCalibrationProcess();
