...
#include <omnicept/lib-abi-cpp/ThreadOwner.h>
...
#include <omnicept/lib-abi-cpp/EyePupillometry.h>
...
namespace Omnicept {
        ...
        *   + Abi::IMUFrame
        */
        class Client : public HP::Omnicept::Utils::ThreadOwner
        {
        public:
        ...
        public:
            ...
            */
            template <class DomainType>
            bool isCallbackRegisteredForType()             
            {
        ...
        protected:
            ...
            std::map<Abi::MessageType, std::function<void(GliaConnection&, std::shared_ptr<Abi::IMessage> message)>> m_callbackMap;
            ...
            std::map<HP::Omnicept::Abi::MessageType, std::shared_ptr<HP::Omnicept::Abi::IMessage>> m_lastValueCacheMap;

            virtual void unblock();
            virtual void readChannel() final;
            virtual void handleMessage(std::shared_ptr<HP::Omnicept::Abi::IMessage> message);
