...
class ValueCategory {
   ...
   constructor(construct_string,label){
      ...
      if (this.#category.min != "-") this.#category.min = parseFloat(this.#category.min);
      if (this.#category.max != "+") this.#category.max = parseFloat(this.#category.max);

      if ((this.#category.min != "-") && (this.#category.max != "+")){
         //console.log("Comparing " + this.#category.min + " with " + this.#category.max);
         if (this.#category.min > this.#category.max){   
