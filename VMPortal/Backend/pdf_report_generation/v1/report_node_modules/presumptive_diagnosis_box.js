...
class PresumptiveDiagnosisBox {
    ...
    * @param {string} [config.right_title] - Title on the right hand side of the box. 
   ...
   render(){
      ...
      // Rendering the right hand side title. 
      ...
      let bb = this.#pdf.getTextDimensions(this.#config.right_title);
      ...
      this.#pdf.text(text,xx,yy,{baseline: "top"})
