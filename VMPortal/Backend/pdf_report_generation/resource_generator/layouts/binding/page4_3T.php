<?php
   ...
   // BC Econding/ UC Encondiing.  
   $item["right_graph"]["left_set"]  = [227.2301,0.7214,208.8938,0.6297];
   // BC Retrieval / UC Retrieval.  
   $item["right_graph"]["right_set"] = [208.8938,0.6297,201.3191,0.6452];
   ...
   $item["right_graph"]["h"] = $height;
   // BC Econding/ UC Encondiing.  
   $item["right_graph"]["left_set"]  = [9.0752,0.012,9.2888,0.012];
   // BC Retrieval / UC Retrieval.  
   $item["right_graph"]["right_set"] = [10.7987,0.0296,10.5517,0.0347 ];
