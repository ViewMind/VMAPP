...
class ReportPage {
   ...
   createNewReportPage(titles) {
      ...
      if (this.#pageCounter > 0){
         ...
         const eyeLogo = 'resources/background_vm_eye_logo.png'
      ...
      const headBkg = 'resources/header_background.png'
      ...
      const vmLogo = 'resources/viewmind_logo_white_tight.png'
      ...
      this.#pdf.text(this.#motto,this.#X_MOTTO,this.#Y_MOTTO,{"baseline" : "hanging"})
