...
class FourPointGraph {
    ...
    * @param {Array}  [config.righSet] - Array of two objects representing the value and the variance of each value drawn in the right hand side. "value" and "variance"
   ...
   renderBackgroud(){
      ...
      for (var i = 1; i < n; i++) {
         var display_value = Math.round(scale_interval*i) + this.#configuration.yUnits;
         var y_pos = y + h - vertical_displacement_interval*i;
   ...
   plotSet(set,color){
      ...
      // Right Side. 
      yvalue  = this.getYValue(this.#configuration.righSet[set].value)
      yplus   = this.getYValue(this.#configuration.righSet[set].value + this.#configuration.righSet[set].variance)
      yminus  = this.getYValue(this.#configuration.righSet[set].value - this.#configuration.righSet[set].variance)
   ...
   computeMaxValue(maxy, miny){
      ...
      values.push(this.#configuration.righSet[0].value + this.#configuration.righSet[0].variance)
      values.push(this.#configuration.righSet[1].value + this.#configuration.righSet[1].variance)
