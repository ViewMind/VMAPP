...
Utils.DimensionMapper.configure(PAGE_WIDTH,PAGE_HEIGHT)
...
everyPageData.leftBoxData = {"Doctor" : "Gerardo Fernandez", "Evaluator": "Matias Shulz", "Date" : "2021-02-15 14:15:16"}
everyPageData.rightBoxData = {"Patient" : "Jason Garmin", "Age" : "61", }      
everyPageData.langKey = {"patient": "Patient", "doctor": "Doctor", "evaluator": "Evaluator", "age": "Age", "date" : "Date"}
everyPageData.langMonthList = ["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];
everyPageData.path = "./"
...
doc.setFillColor("#aa0000")
doc.rect(effectiveArea.x,effectiveArea.y,effectiveArea.w,effectiveArea.h,'F')
