...
#define UIMAP_SECOND_MONITOR_OPTION   5
...
public:
    ...
    Q_INVOKABLE QString getSecondMonitorOption() const { return options.value(UIMAP_SECOND_MONITOR_OPTION); }
