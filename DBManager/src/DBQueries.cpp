    ...
    switch (bsmt){
       ...
       case BSMT_PLACED_PRODUCT:
          cols << TPLACED_PROD_COL_CHINRESTMODEL << TPLACED_PROD_COL_CHINRESTSN << TPLACED_PROD_COL_ETBRAND << TPLACED_PROD_COL_ETMODEL << TPLACED_PROD_COL_ETSERIAL
               << TPLACED_PROD_COL_INSTITUTION << TPLACED_PROD_COL_PCMODEL << TPLACED_PROD_COL_PCSERIALNUM << TPLACED_PROD_COL_PRODSN << TPLACED_PROD_COL_PRODUCT << TPLACED_PROD_COL_SOFTVER
