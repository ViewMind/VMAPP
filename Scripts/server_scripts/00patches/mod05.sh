...
mysql -h $DB_RES_HOST -u $USER -P $PORT --database=$DB_RES_NAME -e "ALTER TABLE tPlacedProducts ADD COLUMN activation_date DATE DEFAULT '0000-00-00'"
mysql -h $DB_RES_HOST -u $USER -P $PORT --database=$DB_RES_NAME -e "ALTER TABLE tPlacedProducts ADD COLUMN production_date DATE DEFAULT '0000-00-00'"
