...
mysql -h $DB_RES_HOST -u $USER -P $PORT --database=$DB_RES_NAME -e "ALTER TABLE tInstitution DROP COLUMN hashpass"
mysql -h $DB_RES_HOST -u $USER -P $PORT --database=$DB_RES_NAME -e "ALTER TABLE tInstitution ADD COLUMN enabled TINYINT DEFAULT 1"
