...
GRANT SELECT ON vm_main.product_processing_parameters TO 'service_client_data_processing'@'%';
...
GRANT SELECT,INSERT,UPDATE ON vm_main.product_processing_parameters TO 'service_administrative_management'@'%';
GRANT SELECT ON vm_secure.placed_products TO 'service_client_data_processing'@'%';
GRANT SELECT ON vm_secure.portal_users TO 'service_client_data_processing'@'%';
...
GRANT SELECT,INSERT,UPDATE ON vm_secure.portal_users TO 'service_administrative_management'@'%';
