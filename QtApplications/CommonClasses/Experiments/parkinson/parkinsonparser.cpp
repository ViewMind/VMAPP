...
//qreal ParkinsonParser::MAZE_AREA_H = 170.0;
//qreal ParkinsonParser::MAZE_AREA_W = 240.0;
//qreal ParkinsonParser::SQUARE_SIDE_X = 40.0;
//qreal ParkinsonParser::SQUARE_SIDE_Y = 40.0;
//#endif
...
qreal ParkinsonParser::K_SQUARE_SIDE_X = 0.021;
qreal ParkinsonParser::K_SQUARE_SIDE_Y = 0.037;
...
bool ParkinsonParser::parseParkinsonExperiment(const QString &contents, qreal screenWidth, qreal screenHeight){
    ...
    qint32 squareSideY = static_cast<qint32>(K_SQUARE_SIDE_Y*screenHeight);
    qint32 squareSideX = static_cast<qint32>(K_SQUARE_SIDE_X*screenWidth);
